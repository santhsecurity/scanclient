# Contributing to scanclient (santh-http)
...
To add new HTTP middleware, retry logic, or proxy support, update the client builder in `src/`. Ensure asynchronous traits are handled properly and test under simulated network latency.
